...
void L336_palindromePairs::insert(string &word, int index) {
...
bool L336_palindromePairs::isPalindrome(const string& word, int i, int j) {
...
void L336_palindromePairs::dfsFindAllPalindromePair(const int& node1, const int& node2, const vector<string>& words) {
